...
public class count_settingActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.count_setting);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.changebirth_button:
                ...
                //调用DatePickerDialog
                new DatePickerDialog(count_settingActivity.this, onDateSetListener, mYear, mMonth, mDay).show();
                break;
            case R.id.exitaccount_button:
                // Use the Builder class for convenient dialog construction
                AlertDialog.Builder builder1 = new AlertDialog.Builder(count_settingActivity.this);
                builder1.setMessage("确定退出账号?")
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                Intent i = new Intent(count_settingActivity.this, log_on_Activity.class);
                                startActivity(i);                            }
                        })
